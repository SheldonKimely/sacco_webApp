                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span
                                        class="text-dark">{{$data->fname}}</span> <i data-feather="chevron-down"
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/borrowed_loans"
                                aria-expanded="false"><i data-feather="calendar" class="feather-icon"></i><span
                                    class="hide-menu">Apply Loan</span></a></li>

                        <li class="sidebar-item"> <a class="sidebar-link" href="/view_repayments"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">View Loan Status
                                </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="/view_repayments"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">View active Loans
                                </span></a>
                        </li>
			...
			<div class="inner">
				...
				@csrf
					...
					<div class="form-holder">
						...
						<input type="number" name="nid" class="form-control" placeholder="National ID Number" required number>
					</div>
					<div class="form-holder">
						<span class="lnr lnr-user"></span>
						<input type="number" name="amount" class="form-control" placeholder="Amount" required number>
					</div>
					<div class="form-holder">
						<span class="lnr lnr-phone-handset"></span>
						<input type="text" name="gname"  class="form-control" placeholder="Name of Guarantor" required>
					</div>
                    <div class="form-holder">
						<span class="lnr lnr-user"></span>
						<input type="number" name="amount" class="form-control" placeholder="Guarantor's National ID number" required number>
					</div>
                    <div class="form-holder">
						<span class="lnr lnr-user"></span>
						<input type="number" name="gphone" class="form-control" placeholder="Guarantor's Phone Number " required number>
					</div>

                    <div class="form-holder">
						<span class="lnr lnr-user"></span>
						<input type="number" name="gaddress" class="form-control" placeholder="Guarantor's Address " required number>
					</div>
