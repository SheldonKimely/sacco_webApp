...
<title>Membersip Applications</title>    <!-- Custom CSS -->
            ...
            <div class="table-responsive">
                <table class="table">
                    <thead>
                        ...
                        <th scope="col">Church Membership No.</th>
                    ...
                    <tbody>
                        ...
                        @foreach($data as $dataValue) 
                            ...
                            <tr>
                                ...
                                <td class="center">{{ $dataValue->email}}</td>
                                <td class="center">{{ $dataValue->phone }}</td>
                                <td class="center">{{ $dataValue->churchMembershipNumber }}</td>
                                <td class="center">{{ $dataValue->department }}</td>
                                <td class="center">{{ $dataValue->service }}</td>
                                <td class="center">{{ $dataValue->status}}</td>
                                <td>
                                    <a class="btn btn-success" href="{{URL ('approved',$dataValue->id)}}">Approve</a>
                                </td>
                                <td>
                                    <a class="btn btn-danger" href="{{URL ('cancelled',$dataValue->id)}}">Cancel</a>
                                </td>
