...
Route::get('/login-user',[Login::class,'index'])->name ('login-user');
...
Route::get("/approved/{id}", [MembershipApplications::class,'approved']);
Route::get("/cancelled/{id}", [MembershipApplications::class,'cancelled']);
