...
<title>Manager Dashboard</title>    <!-- Custom CSS -->
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="/approve_individual"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
...
<div class="form-group">
    ...
    <div class="input-group" style="margin:auto;">
        <input type="text" name="name" class="email form-control" placeholder="Email" required>
    </div>
...
<div class="form-group">
    ...
    <div class="input-group" style="margin:auto;">
        <input type="text" name="email" class="oldpassword form-control" placeholder="Old password" required>
    </div>
...
<div class="form-group">
    ...
    <div class="input-group" style="margin:auto;">
        <input type="text" name="email" class="password form-control" placeholder="New password" required>
    </div>
...
<div class="form-group">
    ...
    <div class="input-group" style="margin:auto;">
        <input type="text" name="phone" class="cpassword form-control" placeholder="Confirm New Password" required> 
    </div>
...
<div class="input-group" style="margin:auto;">
    <button type="submit" class="save_form">Change Password</button> 
</div>
</form>
