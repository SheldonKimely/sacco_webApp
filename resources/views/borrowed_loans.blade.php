                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="/approve_individual"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">Approve Loans
                                </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="/approve_group"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">Approve Group
                                </span></a>
                        </li>
                        ...
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">SHARES</span></li>

                        <li class="sidebar-item"> <a class="sidebar-link" href="/contribute"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">Contibute
                                </span></a>
                        </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link"
                                href="/group_shares" aria-expanded="false"><i data-feather="lock"
                                    class="feather-icon"></i><span class="hide-menu">Group Shares
                                </span></a>
                        </li>
