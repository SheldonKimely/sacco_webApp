...
<div class="form-group">
    ...
    <div class="input-group" style="margin:auto;">
        <input type="text" name="name" class="name form-control" placeholder="Full Name" required>
    </div>
...
<div class="form-group">
    ...
    <div class="input-group" style="margin:auto;">
        <input type="password" name="cpassword" class="cpassword form-control" placeholder="Confirm Password" required> 
    </div>
</div>

<div class="input-group" style="margin:auto;">
    <button type="submit" class="save_form">Register</button> 
</div>
</form>
